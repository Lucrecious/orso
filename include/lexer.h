...
enum token_type_t {
    ...
    TOKEN_PERCENT_EQUAL, TOKEN_PERCENT_PERCENT_EQUAL,

    TOKEN_BANG, TOKEN_HAT, TOKEN_LESS, TOKEN_GREATER,
    TOKEN_EQUAL_EQUAL, TOKEN_BANG_EQUAL, TOKEN_LESS_EQUAL, TOKEN_GREATER_EQUAL,
    TOKEN_BAR, TOKEN_AMPERSAND, TOKEN_AMPERSAND_AMPERSAND, TOKEN_SQUIGGLE,
    ...
    TOKEN_TYPEOF, TOKEN_SIZEOF, TOKEN_LEN, TOKEN_OFFSETPTR, TOKEN_PTRDIFF,
...
enum operator_type_t {
    ...
    OPERATOR_TYPE_COMPARE = 1 << 1,
    OPERATOR_TYPE_ORDERING = 1 << 2,
...
#define operator_is_comparing(op) (operators[op].type == OPERATOR_TYPE_COMPARE)
