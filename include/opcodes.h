...
typedef enum OrsoOPCode {
    ORSO_OP_POP, ORSO_OP_POP_PTR, ORSO_OP_POP_UNION,

    ORSO_OP_PUSH_I64, ORSO_OP_PUSH_PTR,
    ...
    ORSO_OP_CONSTANT, ORSO_OP_CONSTANT_PTR,
    
    ORSO_OP_DEFINE_GLOBAL_STACK, ORSO_OP_DEFINE_GLOBAL_PTR, ORSO_OP_DEFINE_GLOBAL_UNION,
    ORSO_OP_GET_GLOBAL_STACK, ORSO_OP_GET_GLOBAL_PTR, ORSO_OP_GET_GLOBAL_UNION,
    ORSO_OP_SET_GLOBAL_STACK, ORSO_OP_SET_GLOBAL_PTR, ORSO_OP_SET_GLOBAL_UNION,
