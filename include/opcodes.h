...
typedef enum OrsoOPCode {
    ...
    ORSO_OP_DEFINE_GLOBAL, ORSO_OP_DEFINE_GLOBAL_PTR,
    ORSO_OP_GET_GLOBAL, ORSO_OP_GET_GLOBAL_PTR,
    ORSO_OP_SET_GLOBAL, ORSO_OP_SET_GLOBAL_PTR,
