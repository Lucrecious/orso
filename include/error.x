...
ERROR_XMACRO(ERROR_PARSEREX_EXPECTED_EOF_AFTER_MODULE, "expected the end of the file after the module", PARSER)
ERROR_XMACRO(ERROR_PARSEREX_EXPECTED_SEMICOLON_AFTER_STRUCT_DECLARATION, "expected ';' after a declaration inside a struct block", PARSER)
ERROR_XMACRO(ERROR_PARSEREX_EXPECTED_SEMICOLON_AFTER_DECLARATION, "expected ';' after a statement or definition", PARSER)
