...
bool symbol_table_get(symbol_table_t* table, struct symbol_t* symbol, slot_t* value);
bool symbol_table_set(symbol_table_t* table, struct symbol_t* symbol, slot_t value);
